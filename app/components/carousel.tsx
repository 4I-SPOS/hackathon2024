        ...
        <div className="h-[70vh] relative flex items-center">
            <div className='w-full h-full flex items-center'>
                <div className="py-10 px-24 flex flex-col gap-5 ">
                    ...
                    <p className="z-30 text-white w-1/3">Nebojte se vyzkoušet náš chytrý dotazník. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent sed mollis nisi, ac maximus urna.</p>
                </div>
            </div>
